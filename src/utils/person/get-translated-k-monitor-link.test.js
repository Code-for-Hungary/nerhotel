...
describe("A function to get a Google Translate link for the person database URLs", () => {
    it("returns a Google Translate URL", () => {
        expect(getTranslatedKMonitorLink("https://adatbazis.k-monitor.hu/adatbazis/cimkek/scheer-sandor", "en")).toEqual(
    ...
    it("can dynamically change the output language of the returned Google Translate URL", () => {
        expect(getTranslatedKMonitorLink("https://adatbazis.k-monitor.hu/adatbazis/cimkek/scheer-sandor", "de")).toEqual(
